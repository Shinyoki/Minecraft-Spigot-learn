...
import com.senko.tabexecutorplugin.commands.impl.GodModeCmd;
import com.senko.tabexecutorplugin.commands.impl.HelpCmd;
...
public class CommandHandler implements TabExecutor {
    ...
    private void initHandler() {
        ...
        commands.put("godmode", new GodModeCmd());
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args == null || args.length < 1) {
            //showHelp用于只输入/sub 而没有指明具体指令的情况
            showHelp(sender);
            return true;
        }
