...
public class AnotherBlockDataExample {
    public void doSetBlockData(Block clickedBlock, Player player) {
        if (clickedBlock.getType() == Material.DIAMOND_BLOCK) {
             ...
             */
            clickedBlock.setBlockData(airBlockData, false);         // 关闭方块更新的修改
//            clickedBlock.setBlockData(airBlockData);                      // 默认启用方块更新的修改
